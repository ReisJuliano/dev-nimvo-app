    ...
    protected function serializeLocalAgent(
        ...
        return [
            ...
            'device' => [
                ...
                'certificate_company_name' => data_get($agent->metadata, 'device.certificate.company_name'),
                'certificate_cnpj' => data_get($agent->metadata, 'device.certificate.cnpj'),
                'certificate_valid_from' => data_get($agent->metadata, 'device.certificate.valid_from'),
                'certificate_valid_to' => data_get($agent->metadata, 'device.certificate.valid_to'),
