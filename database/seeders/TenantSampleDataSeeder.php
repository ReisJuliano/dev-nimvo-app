...
class TenantSampleDataSeeder extends Seeder
{
    ...
    {
        $base = now()->subDays(15)->setTime(8, 0);
    ...
    protected function categoryEntries(): array
    {
        return [
            ...
            ['key' => 'pet', 'name' => 'Amostra Pet Shop', 'description' => 'Amostra de itens para animais.', 'active' => false],
            ['key' => 'utilidades', 'name' => 'Amostra Utilidades', 'description' => 'Embalagens e utilidades para o caixa.', 'active' => false],
        ];
    }
    ...
    protected function supplierEntries(): array
    {
        return [
            ...
            ['key' => 'pet_center', 'name' => 'Amostra Pet Center', 'trade_name' => 'Pet Center', 'document' => '11222333000109', 'state_registration' => '110223352', 'phone' => '11991000009', 'email' => 'pet@amostra.test', 'city_name' => 'Campinas', 'state' => 'SP', 'active' => false],
            ['key' => 'embalagens_sul', 'name' => 'Amostra Embalagens Sul', 'trade_name' => 'Emb Sul', 'document' => '11222333000110', 'state_registration' => '110223353', 'phone' => '11991000010', 'email' => 'embalagens@amostra.test', 'city_name' => 'Santos', 'state' => 'SP', 'active' => false],
        ];
    }
    ...
    protected function customerEntries(): array
    {
        return [
            ...
            ['key' => 'bruno', 'name' => 'Cliente Amostra Bruno Reis', 'document' => '12345678902', 'phone' => '11992000002', 'email' => 'bruno@cliente.test', 'street' => 'Rua do Comercio', 'number' => '88', 'complement' => 'Sala 2', 'district' => 'Mooca', 'city_name' => 'Sao Paulo', 'city_code' => '3550308', 'state' => 'SP', 'zip_code' => '03104000', 'credit_limit' => 500, 'active' => true],
            ['key' => 'carla', 'name' => 'Cliente Amostra Carla Dias', 'document' => '12345678903', 'phone' => '11992000003', 'email' => 'carla@cliente.test', 'street' => 'Av Paulista', 'number' => '1500', 'complement' => 'Apto 33', 'district' => 'Bela Vista', 'city_name' => 'Sao Paulo', 'city_code' => '3550308', 'state' => 'SP', 'zip_code' => '01310200', 'credit_limit' => 650, 'active' => true],
            ...
            ['key' => 'isabela', 'name' => 'Cliente Amostra Isabela Teixeira', 'document' => '12345678909', 'phone' => '11992000009', 'email' => 'isabela@cliente.test', 'street' => 'Rua da Praca', 'number' => '300', 'complement' => null, 'district' => 'Vila Matilde', 'city_name' => 'Sao Paulo', 'city_code' => '3550308', 'state' => 'SP', 'zip_code' => '03513000', 'credit_limit' => 280, 'active' => true],
    ...
    protected function saleEntries(Carbon $base): array
    {
        return [
            ...
            ['key' => 'sale-002', 'user' => 'attendant', 'customer' => 'bruno', 'sold_at' => $base->copy()->subDays(8)->setTime(10, 40), 'notes' => 'Venda de amostra com pagamento pix.', 'payments' => [['method' => 'pix', 'amount' => null]], 'items' => [['product_code' => 'AMST-PRD-002', 'qty' => 3]]],
            ['key' => 'sale-003', 'user' => 'operator', 'customer' => 'carla', 'sold_at' => $base->copy()->subDays(7)->setTime(12, 20), 'notes' => 'Venda de amostra para mix refrigerado.', 'payments' => [['method' => 'credit_card', 'amount' => null]], 'items' => [['product_code' => 'AMST-PRD-003', 'qty' => 1], ['product_code' => 'AMST-PRD-005', 'qty' => 2]]],
            ['key' => 'sale-004', 'user' => 'attendant', 'customer' => 'erica', 'sold_at' => $base->copy()->subDays(6)->setTime(14, 5), 'notes' => 'Venda de amostra a prazo.', 'payments' => [['method' => 'credit', 'amount' => null]], 'items' => [['product_code' => 'AMST-PRD-006', 'qty' => 2]]],
            ...
            ['key' => 'sale-006', 'user' => 'attendant', 'customer' => 'henrique', 'sold_at' => $base->copy()->subDays(4)->setTime(16, 10), 'notes' => 'Venda de amostra para carteira a prazo.', 'payments' => [['method' => 'credit', 'amount' => null]], 'items' => [['product_code' => 'AMST-PRD-009', 'qty' => 1]]],
