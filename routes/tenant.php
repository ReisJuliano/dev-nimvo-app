...
use App\Http\Controllers\Tenant\Customers\CustomerImportController;
use App\Http\Controllers\Tenant\Suppliers\SupplierImportController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware([EnsurePasswordIsChanged::class, 'tenant.license', 'module.enabled'])->group(function () {
        ...
        Route::prefix('/api')->group(function () {
            ...
            Route::post('/customers/import/preview', [CustomerImportController::class, 'preview'])->name('api.customers.import.preview');
            Route::post('/customers/import/commit', [CustomerImportController::class, 'commit'])->name('api.customers.import.commit');
            Route::post('/suppliers/import/preview', [SupplierImportController::class, 'preview'])->name('api.suppliers.import.preview');
            Route::post('/suppliers/import/commit', [SupplierImportController::class, 'commit'])->name('api.suppliers.import.commit');
